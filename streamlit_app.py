...
if st.button("Send"):
    ...
    primer = f"""You are a customer support agent working for The Edge. Answer the following question using the context provided. The context may have formatting errors. Respond using markdown."""
