...
if st.button("Send"):
    ...
    primer = f"""You are a customer support agent working for The Edge. You are clear and concise with your answers. Answer the following question using the context provided. The context may have formatting errors. Respond using markdown."""
